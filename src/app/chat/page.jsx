...
const Chat = () => {
    ...
    const sendMessage = (e) => {
        if(e.code === 'Enter'){
            ...
            const temp = {message: e.target.value};
...
return (
  ...
  <div className="relative h-screen ">
    <div className="py-10 lg:py-14">
      ...
      {/* End Title */}
      <ul className="pb-32 mt-16 space-y-5">
        {/* Chat Bubble */}
        ...
        {Message.map((mess , index) => {
            return (
                ...
                <ul key={index}><li className="py-2 sm:py-4 ">
                        <div className="max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto flex justify-end">
                            <div className="max-w-2xl flex gap-x-2 sm:gap-x-4 ">
                                <div className="grow mt-2 space-y-3 flex justify-end">
                    ...
                    <div className="space-y-3">
                        <h2 className="font-medium text-gray-800 dark:text-black">
    ...
    {/* Textarea */}
    <footer className="fixed w-full bottom-0 z-10 bg-white border-t border-gray-200 pt-2 pb-3 sm:pt-4 sm:pb-6 dark:bg-neutral-900 dark:border-neutral-700">
